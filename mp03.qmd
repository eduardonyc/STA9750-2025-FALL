...
# Create Table 3 with focus species
...
# Create table with unique ID for CSS targeting
dt_focus_breakdown <- datatable(
  coalition_focus_with_totals,
  elementId = "task5_table3", 
  rownames = FALSE,
  class = "compact stripe hover",
  options = list(
    pageLength = 6,
  ...
  caption = tags$caption(
    style = "caption-side: top; text-align: left; font-weight: 700; font-size: 1.05em; margin-bottom: 8px;",
...
# Custom CSS to reduce font size and eliminate scroll
dt_focus_breakdown <- htmlwidgets::prependContent(
  dt_focus_breakdown,
  tags$style(HTML("
    #task5_table3 table.dataTable {
      font-size: 11px;  /* Reduced from default ~14px */
    }
    #task5_table3 table.dataTable thead th {
      font-size: 10.5px;  /* Smaller header font */
      padding: 6px 4px;  /* Tighter padding */
    }
    #task5_table3 table.dataTable tbody td {
      padding: 5px 4px;  /* Tighter cell padding */
    }
    #task5_table3 .dataTables_wrapper {
