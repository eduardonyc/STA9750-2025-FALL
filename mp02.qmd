...
#| fig-cap: "Figure 1: Data Integration Architecture: Entity Relationships & Transformation Logic Across Federal Data Sources"
#| out-width: "100%"
#| results: 'asis'
...
- **BLS Wage Data** use formatted `FIPS` strings  strings with "C" prefix (e.g., "C1018" for what Census calls CBSA 10180 - note BLS drops the trailing zero)
