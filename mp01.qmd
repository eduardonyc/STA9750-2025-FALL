...
Netflix is gearing up to release the fifth season of the *Stranger Things* series in late November 2025. This final season will bring to a close the global phenomenon that has earned record setting viewing hours throughout 93 countries since its 2016 debut.
...
datatable(
  ...
  caption = tags$caption(
    ...
    HTML(sprintf(
      "Stranger Things, Charting in <b>%s countries</b>, Averaging <b>%s Weeks</b> Per Country",
...
Standout titles such as *Heeramandi: The Diamond Bazaar*, *Animal*, and *The Great Indian Kapil Show* have collectively drawn substantial views from global audiences, highlighting their success on Netflix's Global Top 10 weekly charts. Among its broader catalog, Netflix's offers Indian viewers 363 titles unavailable in the US that have achieved global Top 10 status. These titles represent nearly 50% of India's available streaming content, which demonstrates high levels of demand for region-specific programming from international audiences.
...
As South Asia's content continues to attract global audiences, Netflix can deepen its regional presence by expanding Urdu-language programming. Widely spoken across India and Pakistan, Urdu offers a strategic opportunity to create culturally connected content that bridges borders while uniting diverse audiences. 
