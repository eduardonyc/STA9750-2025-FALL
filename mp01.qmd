...
# ============================================
# TABLE 1: Top Show/Season by Country (with pagination)
# ============================================
...
COUNTRY_TOP_10 %>%
  ...
  datatable(
    options = list(
      ...
      pageLength = 3,       # Default to 3 entries per page
      lengthMenu = list(c(3, 5, 10, 17), c('3', '5', '10', 'All'))  # Dropdown options
    ),
    caption = htmltools::tags$caption(
      style = "caption-side: bottom; text-align:center; color:#666; font-size:0.9em; padding-top:8px;",
  ...
  bind_rows(
    summarise(., across(where(is.numeric), sum, na.rm = TRUE)) %>%
      mutate(
        ...
        `Show Title` = "—",
        `Season Title` = "—",
        `*Avg Runtime (hrs)` = NA_real_  # Set to NA instead of 0
      )
  )
...
datatable(
  ...
  options = list(
    ...
    paging = FALSE, 
    info = FALSE,
    columnDefs = list(list(className = 'dt-left', targets = "_all"))  # Left justify all columns
  ),
  caption = htmltools::tags$caption(
    style = "caption-side: bottom; text-align:center; color:#666; font-size:0.9em; padding-top:8px;",
