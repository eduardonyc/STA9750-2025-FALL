...
# Top show per country by cumulative weeks, keep top 10 countries
...
# GLOBAL TOTALS (sum across all weeks) + best global rank
...
# Combine using the TOTALS, not a single week
combined_data <- latam_top %>%
  ...
  transmute(
    ...
    `Global Hours Viewed` = global_total_hours,   # <-- use TOTALS
