...
While the <a href="https://tiffany-ngli.github.io/STA9750-2025-FALL/Summary%20Report.html" target="_blank">team's broader effort</a> examines crime, density, job accessbility, and transit, this analysis isolates Educational Attainment (EA). Historically, High-EA neighborhoods commanded significant price premiums from well-known <a href="https://www.annualreviews.org/deliver/fulltext/resource/11/1/annurev-resource-100518-094151.pdf?itemId=/content/journals/10.1146/annurev-resource-100518-094151&mimeType=application/pdf" target="_blank">agglomeration effects</a>. However, the pandemic’s disruption of physical proximity necessitates a re-evaluation of this premium. Consequently, this study seeks to answer the specific question (SQ):
...
library(plotly)  # spatial heterogeniety analysis   
