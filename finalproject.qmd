...
This analysis integrates four data sources through programmatic retrieval, standardizing incongruent spatial boundaries to align coding systems across federal and city databases.

### Setup and Configuration

Loading required packages and defining global constants allows for programmatically assembling a 59 CD-level panel for 2017–2019 vs. 2021–2023 and merging it with baseline 2019 American Community Survey (ACS) education variables.
...
The `get_dof_sales_year_boro()` function automates the collection and cleaning Annualized Sales reports from the NYC Department of Finance (DOF). Additionally, exclusion criteria filters transactions under $10,000 and restrict the sample to <a href="https://www.nyc.gov/site/finance/property/definitions-of-property-assessment-terms.page" target="_blank">residential tax classes</a>, specifically 1, 2, 2A, 2B, and 2C.  
