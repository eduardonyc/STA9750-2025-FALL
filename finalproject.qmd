...
library(kableExtra)  # For row formatting
...
# Prepare data with regression lines for each borough
...
# Get unique boroughs for legend ordering
...
# Add annotation for citywide pattern - positioned lower
p <- p %>%
  add_annotations(
    x = 0.02,
    y = 1.28,  # Moved down from 0.98 to 0.88
    xref = "paper",
    yref = "paper",
    text = paste0(
