...
Pre-COVID, there was a strong linear correlation (*r* = 0.78) between neighborhood EA and its property value, as shown in Figure 3 below. 
...
The post-COVID scatter plot in Figure 4 below reveals a weaker but still positive relationship between EA and property values (*r* = 0.74, down from *r* = 0.78 pre-COVID). 
