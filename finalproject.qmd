...
The `get_dof_sales_year_boro()` function automates collecting and cleaning Annualized Sales reports from the NYC Department of Finance (DOF). Additionally, exclusion criteria filters transactions under $10,000 and restrict the sample to <a href="https://www.nyc.gov/site/finance/property/definitions-of-property-assessment-terms.page" target="_blank">residential tax classes</a>, specifically 1, 2, 2A, 2B, and 2C.  
